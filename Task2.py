...
Combined_data = extract_datetime_features (Combined_data) # type: ignore
...
for batch in tqdm(np.array_split(X_resampled, 10), desc="Applying Incremental PCA"): ipca.partial_fit(batch)
